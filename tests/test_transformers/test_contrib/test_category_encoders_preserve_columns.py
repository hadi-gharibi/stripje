...
import stripje
from stripje.transformers.contrib.category_encoders_transformers import _safe_fit_supervised_encoder
...
class TestCategoryEncodersPreserveColumns:
    ...
    def _test_encoder_preserves_columns(self, encoder_class, **encoder_kwargs):
        ...
        if encoder_class in [ce.TargetEncoder, ce.CatBoostEncoder, ce.LeaveOneOutEncoder]:
    ...
    @pytest.mark.skip(reason="TargetEncoder has sklearn compatibility issues in pipelines")
    ...
    @pytest.mark.skip(reason="CatBoostEncoder has sklearn compatibility issues in pipelines")
    ...
    @pytest.mark.skip(reason="LeaveOneOutEncoder has sklearn compatibility issues in pipelines")
