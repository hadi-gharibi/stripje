    ...
    def test_benchmark_verification_logic(self, benchmark_data):
        ...
        transformers = [
            ...
            (
                ...
                QuantileTransformer(output_distribution="uniform", n_quantiles=100),
            ),
        ...
        for name, transformer in transformers:
            ...
            component = (
                pipeline.named_steps.get("component")
                or list(pipeline.named_steps.values())[0]
            )
            if (
                hasattr(component, "output_distribution")
                and component.output_distribution == "normal"
            ):
                # Relaxed tolerance for normal distribution
                verification = np.allclose(
